...
SECRET_KEY = 'django-insecure-b)mbmer)32bgf448v$ph6**0-5v#rhv6f8rla%!*@q(noa&otg'
...
INSTALLED_APPS = [
    ...
    'apps.nlquery.apps.NlqueryConfig',   # ← NUEVA APP
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',   # ← ESTO ES CLAVE
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = BASE_DIR / 'staticfiles'   # ← ESTO FALTABA
